                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Nome</label>
                                                <input name="name" type="text" class="form-control" value="{{ Auth::user()->name }}" require>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>E-mail</label>
                                                <input name="email" type="text" class="form-control" value="{{ Auth::user()->email }}" require>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Alterar Senha</label>
                                                <input name="password" type="password" class="form-control" value="" require>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Confirma Senha</label>
                                                <input name="password_confirmation" type="password" class="form-control" value="" require>
                                            </div>
                                        </div>
                                    </div>
